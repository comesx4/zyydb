    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
					<input placeholer='BPG百兆端口流量费' type='text' name='flow_bgp_port' value=''/>
				</td>
            </tr>
            <tr>
                <td class='first'>BPG流量费：</td>
                <td>
					<input placeholer='BPG流量费' type='text' name='flow_bgp' value=''/>
				</td>
            </tr>
            <tr>
                <td class='first'>静态百兆端口流量费：</td>
                <td>
					<input placeholer='静态百兆端口流量费' type='text' name='flow_static_port' value=''/>
				</td>
            </tr>
            <tr>
                <td class='first'>静态流量费：</td>
                <td>
					<input placeholer='静态流量费' type='text' name='flow_static' value=''/>
				</td>
            </tr>
            <tr>
