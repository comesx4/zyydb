    ...
    <table class="table" <?php if($isSort): ?>data-sort="true"<?php endif; ?>>
        <thead>
            <tr>
                ...
                <authority>
                	<a class="btn btn-success" href="<?php echo U('add');?>">添加整柜</a>
                </authority>
                </td>
        ...
        <tbody>
            <tr>
                ...
                <th>静态流量费</th>
                <th>地点</th>
                <th data-sort="true" data-field="time">每增配1个IP地址价格</th>
            ...
            <?php if(is_array($data)): foreach($data as $key=>$row): ?><tr>
                ...
                <td><?php echo ($row["flow_bgp_port"]); ?></td>
                <td><?php echo ($row["flow_bgp"]); ?></td>
                <td><?php echo ($row["flow_static_port"]); ?></td>
                <td><?php echo ($row["flow_static"]); ?></td>
                <td><?php echo (get_city_name($row["location"])); ?></td>
				<td><?php echo ($row["price"]); ?></td>
                <td><?php echo ($row["ip_price"]); ?></td>
                <td><?php echo ($row["comment"]); ?></td>
                <td><?php echo ($row["sort"]); ?></td>
                <td><?php echo (getkeyname($row["online"],'Online')); ?></td>
                <td>
                <authority>
