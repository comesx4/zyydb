...
<form action='<?php echo U('save');?>' method='post'>
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <td class='first'>BPG百兆端口流量费：</td>
                <td>
					<input placeholer='BPG百兆端口流量费' type='text' name='flow_bgp_port' value='<?php echo ($data["flow_bgp_port"]); ?>'/>
				</td>
            </tr>
            <tr>
                <td class='first'>BPG流量费：</td>
                <td>
					<input placeholer='BPG流量费' type='text' name='flow_bgp' value='<?php echo ($data["flow_bgp"]); ?>'/>
				</td>
            </tr>
            <tr>
                <td class='first'>静态百兆端口流量费：</td>
                <td>
					<input placeholer='静态百兆端口流量费' type='text' name='flow_static_port' value='<?php echo ($data["flow_static_port"]); ?>'/>
				</td>
            </tr>
            <tr>
                <td class='first'>静态端口流量费：</td>
                <td>
					<input placeholer='静态流量费' type='text' name='flow_static' value='<?php echo ($data["flow_static"]); ?>'/>
				</td>
            </tr>
            <tr>
