...
/**
 * Description of Goodsorder_22ViewModel
 *
 * @author 范利丰 <feiyufly001@hotmail.com>
 */
class Goodsorder_22ViewModel  extends GoodsorderViewModel{
     public $viewFields = array(
        ...
        'storage_server_package' => array(
            'name'=>'productname',
            '_on' => 'goodsorder.pid=storage_server_package.id',
            '_type' => 'LEFT'
        ),
          'admin' => array(
            'username'=>'adminname',
